			...
			<div class="page-breadcrumb">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url('home/konfirmasi_pembelian/').$belimobil['id_beli'].'/'.$id_mobil ?>" class="breadcrumb-link">Konfirmasi Pembelian</a></li>
			...
			<div class="card-body">
				<div class="container">
					<div class="text-center">
						...
						<br>
						<h2 class="text-secondary">Rp. <?php echo $belimobil['harga'] ?></h2>
					</div>
					<br>
					<div>
